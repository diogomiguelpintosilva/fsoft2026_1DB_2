...
ViewCliente::ViewCliente(ClienteController& clienteController, ContaOrdemController& contaOrdemController, GerenciamentoController& gerenciamentoController, ViewContaController& viewContaController):clienteController(clienteController),contaOrdemController(contaOrdemController),gerenciamentoController(gerenciamentoController),viewContaOrdem(viewContaOrdem){}
...
void ViewCliente::mostrarMenu(Cliente* cliente) {
    ...
    do {
        ...
        std::cout<< "3. Ver gerenciamento finaceiro\n";
        std::cout<< "4. Listar todas as contas\n";
        std::cout<< "0. Terminar sessão\n";
        std::cout<< " Opcao: ";
        std::cin >> opcao;
        limparInput();
        ...
        switch (opcao) {
            ...
            case 0: std::cout<< "Sessão terminada.\n"; break;
...
void ViewCliente::opcaoAcederConta(Cliente* cliente) {
    ...
    if (conta != nullptr) {
        viewContaOrdem.mostarMenu(conta);
    }else {
        pausar();
    }
}
