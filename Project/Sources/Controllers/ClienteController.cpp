...
ClienteContorller::ClienteController (ClienteSevice& clienteService):clienteService(clienteService){}
...
Cliente* ClienteController::autenticar (const std::string& nif, const std::string& password) {
